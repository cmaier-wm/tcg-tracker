...
- PostgreSQL 17-backed account settings shared across web and iOS, with signed-out surfaces defaulting to dark mode (002-user-settings)
...
- PostgreSQL 17 for users, sessions, account-owned portfolio data, account-owned settings, and account-owned Teams settings (006-user-login)
