...
<!--
  ...
  - Traced into implementation tasks without ambiguity
-->
...
<!--
  Every requirement MUST be traceable to one or more user stories. When a
  requirement adds a dependency, integration point, or operational constraint,
...
<!--
  Success criteria MUST be verifiable. If an outcome cannot be checked through
  automation, the spec MUST make the required manual verification observable.
-->
...
<!--
  ...
  Replace assumptions with concrete decisions in plan.md before implementation
  starts; implementation-ready tasks MUST NOT rely on unresolved assumptions.
-->
