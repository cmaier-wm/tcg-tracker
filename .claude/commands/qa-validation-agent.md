Validate requirements coverage, prepare seed data, and run smoke checks for a demo-ready increment.

Shared source of truth: `.agents/skills/qa-validation-agent/SKILL.md`.
...
<!-- Generated from .agents/skills/qa-validation-agent/SKILL.md by WM AI exporter -->
