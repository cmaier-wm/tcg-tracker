Create a concise QA plan, scenario matrix, seed-data approach, and smoke-test checklist.

Shared source of truth: `.agents/skills/wm-qa-plan/SKILL.md`.
...
<!-- Generated from .agents/skills/wm-qa-plan/SKILL.md by WM AI exporter -->
