Generate a West Monroe-style architecture decision record from the current decision context.

Shared source of truth: `.agents/skills/wm-adr/SKILL.md`.
...
<!-- Generated from .agents/skills/wm-adr/SKILL.md by WM AI exporter -->
