Review a change against West Monroe quality, security, testing, and client-delivery expectations.

Shared source of truth: `.agents/skills/wm-pr-review/SKILL.md`.
...
<!-- Generated from .agents/skills/wm-pr-review/SKILL.md by WM AI exporter -->
