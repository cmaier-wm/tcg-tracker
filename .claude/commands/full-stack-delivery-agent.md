Implement a scoped feature with tests while following the existing codebase patterns.

Shared source of truth: `.agents/skills/full-stack-delivery-agent/SKILL.md`.
...
<!-- Generated from .agents/skills/full-stack-delivery-agent/SKILL.md by WM AI exporter -->
